...
int main(int argc, char* argv[])
{
	...
	signal(SIGCHILD, handle_subprocess_exit);

	cpu_core_num = get_nprocs();
	printf("cup core num:%d\n", cpu_core_num);
...
void process(int listen_fd)
{
	...
	int epoll_fd = epoll_cread(MAX_EVENT_NUM);
